// config.js — configurazione del backend.
//
// Finche GAS_URL e vuoto, l'app usa lo store MOCK in memoria (dati di esempio,
// persi al refresh) cosi puoi provarla subito.
//
